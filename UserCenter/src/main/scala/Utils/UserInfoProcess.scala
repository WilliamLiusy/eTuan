...
case object UserInfoProcess {
  ...
  // // val logger = LoggerFactory.getLogger(getClass)  // 同文后端处理: logger 统一  // 同文后端处理: logger 统一
  ...
  // // val logger = LoggerFactory.getLogger("generateUserToken")  // 同文后端处理: logger 统一  // 同文后端处理: logger 统一
